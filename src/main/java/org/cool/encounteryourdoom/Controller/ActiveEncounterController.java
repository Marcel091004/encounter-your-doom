...
public class ActiveEncounterController implements ActiveEncounterApi {
    ...
    @Override
    public ResponseEntity<Void> updateCreatureInActiveEncounterForUser(UUID userId, UUID creatureId, Integer heal, Integer damage, List<StatusEffects> statusEffect) {
        //TODO this is not yet implemented
